...
public sealed record CreateUser(string UserName, string FriendlyName, string? Email, ImmutableArray<string> Roles, ImmutableArray<int> CentroCostos, ImmutableArray<int> Franquicias) : IUserChangeable;
