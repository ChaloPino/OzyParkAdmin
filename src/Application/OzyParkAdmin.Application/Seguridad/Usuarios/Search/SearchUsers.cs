...
public sealed record SearchUsers(
    ClaimsPrincipal User,
    string? SearchText,
    FilterExpressionCollection<Usuario> FilterExpressions,
    SortExpressionCollection<Usuario> SortExpressions,
    int Page,
    int PageSize) : IQueryPagedOf<UsuarioFullInfo>;
