...
/// <summary>
/// El modal para crear varios cupos por fecha.
/// </summary>
public partial class CreateCuposFechaDialog
{
    private MudForm form = default!;
    private CuposFechaModel cuposFecha = new();
    ...
    /// </summary>
    [Parameter]
    public Func<CuposFechaModel, Task<bool>> CommitChanges { get; set; } = (_) => Task.FromResult(true);
